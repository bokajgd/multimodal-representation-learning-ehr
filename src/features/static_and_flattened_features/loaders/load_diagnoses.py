...
def _load_icd9_range(icd9_range: tuple[int, int], nrows: Optional[int] = None) -> pd.DataFrame:
...
def load_acquired_immunodeficiency_syndrome(
    ...
    """Load all acquired immunodeficiency syndrome A-diagnoses for each admission.
    """
